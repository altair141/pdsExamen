...
import capaNegocio.fichamedica.Visita;
...
/*	public String registrarCierreCasoMedico(String json) {
		try {
			...
			System.out.println("id rce caso ws "+cierreCaso.getRce().getIdRce());
...
*/
	...
	public String registrarVisita(String jsonVisita){	
		Visita visita=new Visita();
		VisitaVO visitoVo=Transformar.jsonVisita(jsonVisita);
		String resultado=visita.registrarVisitaOpenmrs(visitoVo);
	...
	public String registrarEncuentro(String jsonEncuentro){	
		...
		EncuentroVO encuentroVo=Transformar.jsonEncuentro(jsonEncuentro);
	...
	public String horaesAps(String idHoramedica){
		int id=Transformar.stringToInt(idHoramedica);
