...
public class RceVO {
    ...
    private List<RecetaVO> listaReceta=new ArrayList<RecetaVO>();
    public RceVO() {
        super();
    }
    ...
    public List<RecetaVO> getListaReceta() {
        return listaReceta;
    }

    public void setListaReceta(List<RecetaVO> receta) {
        this.listaReceta = receta;
    }
    public void agregarReceta(RecetaVO receta){
