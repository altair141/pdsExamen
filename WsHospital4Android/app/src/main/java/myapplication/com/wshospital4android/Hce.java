...
public class Hce extends Activity {
    ...
    private class AsyncCallWS extends AsyncTask<String, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            ...
            List<RceVO> listaRce= Transformar.jsonToRce3(resul);
            for(RceVO rce:listaRce){
                arrayList.add(rce.getIdRce()+"");
                String fecha=Transformar.datetoString(rce.getFechaAtencion())+"     "+rce.getHoraInicioAtencion();
            ...
            txtSaludo.setText(fichaMedi+" - "+listaRce.get(0).getIdHce().getPaciente().getNombre()+" "+listaRce.get(0).getIdHce().getPaciente().getApellidos());
