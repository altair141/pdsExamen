...
public class RetrieveAndUpdateTaller2Data {
	public void retrieveAndUpdateTestData() throws PersistentException {
		...
		try {
			...
			orm.CierreCaso lormCierreCaso = orm.CierreCasoDAO.loadCierreCasoByQuery(null, null);
			// Update the properties of the persistent object
	...
	public void retrieveByCriteria() throws PersistentException {
		...
		System.out.println("Retrieving CierreCaso by CierreCasoCriteria");
		orm.CierreCasoCriteria lormCierreCasoCriteria = new orm.CierreCasoCriteria();
		// Please uncomment the follow line and fill in parameter(s)
		//lormCierreCasoCriteria.id.eq();
		System.out.println(lormCierreCasoCriteria.uniqueCierreCaso());
