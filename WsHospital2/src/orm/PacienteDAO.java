...
public class PacienteDAO {
	...
	public static boolean save(orm.Paciente paciente) throws PersistentException {
		try {
			orm.Taller2PersistentManager.instance().saveObject(paciente);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(orm.Paciente paciente) throws PersistentException {
		try {
			orm.Taller2PersistentManager.instance().deleteObject(paciente);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(orm.Paciente paciente)throws PersistentException {
		try {
			...
			if(paciente.getHce() != null) {
				paciente.getHce().setIdPaciente(null);
			}
	...
	public static boolean refresh(orm.Paciente paciente) throws PersistentException {
		try {
			orm.Taller2PersistentManager.instance().getSession().refresh(paciente);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(orm.Paciente paciente) throws PersistentException {
		try {
			orm.Taller2PersistentManager.instance().getSession().evict(paciente);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
