...
public class RceCriteria extends AbstractORMCriteria {
	...
	public RceCriteria(Criteria criteria) {
		...
		cierreCasoId = new IntegerExpression("cierreCaso.idRce", this);
		cierreCaso = new AssociationExpression("cierreCaso", this);
	}
	...
	public CierreCasoCriteria createCierreCasoCriteria() {
		return new CierreCasoCriteria(createCriteria("cierreCaso"));
	}
