...
public class RceDetachedCriteria extends AbstractORMDetachedCriteria {
	...
	public final IntegerExpression cierreCasoId;
	public final AssociationExpression cierreCaso;
	...
	public RceDetachedCriteria() {
		...
		cierreCasoId = new IntegerExpression("cierreCaso.idRce", this.getDetachedCriteria());
		cierreCaso = new AssociationExpression("cierreCaso", this.getDetachedCriteria());
	}
	...
	public CierreCasoDetachedCriteria createCierreCasoCriteria() {
		return new CierreCasoDetachedCriteria(createCriteria("cierreCaso"));
	}
