...
<body>
	...
	<%
		...
		try {
			diagnostico = Transformar.jsonToDiagnostico2(diagnosticos);			
			procedimiento = Transformar.jsonToProcedimiento2(procedimientos);
			actividad = Transformar.jsonToActividad2(actividades);
			...
			<form method="post" action="CrearRce">
				...
				<div class="row">
					<div class="col-lg-6">
						...
						%>
						<select multiple class="form-control" id="selecdiag"
							name="diagnostico">
				...
				<script>
					...
					function mostrarProcedimientoPorDiagnostico() {
						...
						var i = 0;
						$("#selecdiag option:selected").each(function() {
							arraySelect[i] = $(this).val();
							i++;
						});
