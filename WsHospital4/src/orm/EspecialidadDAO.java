...
public class EspecialidadDAO {
	public static Especialidad loadEspecialidadByORMID(int idEspecialidad) throws PersistentException {
		try {
			PersistentSession session = orm.Taller2PersistentManager.instance().getSession();
			return loadEspecialidadByORMID(session, idEspecialidad);
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static Especialidad getEspecialidadByORMID(int idEspecialidad) throws PersistentException {
		try {
			PersistentSession session = orm.Taller2PersistentManager.instance().getSession();
			return getEspecialidadByORMID(session, idEspecialidad);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Especialidad loadEspecialidadByORMID(int idEspecialidad, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = orm.Taller2PersistentManager.instance().getSession();
			return loadEspecialidadByORMID(session, idEspecialidad, lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Especialidad getEspecialidadByORMID(int idEspecialidad, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = orm.Taller2PersistentManager.instance().getSession();
			return getEspecialidadByORMID(session, idEspecialidad, lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Especialidad loadEspecialidadByORMID(PersistentSession session, int idEspecialidad) throws PersistentException {
		try {
			return (Especialidad) session.load(orm.Especialidad.class, new Integer(idEspecialidad));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Especialidad getEspecialidadByORMID(PersistentSession session, int idEspecialidad) throws PersistentException {
		try {
			return (Especialidad) session.get(orm.Especialidad.class, new Integer(idEspecialidad));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Especialidad loadEspecialidadByORMID(PersistentSession session, int idEspecialidad, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Especialidad) session.load(orm.Especialidad.class, new Integer(idEspecialidad), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Especialidad getEspecialidadByORMID(PersistentSession session, int idEspecialidad, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Especialidad) session.get(orm.Especialidad.class, new Integer(idEspecialidad), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static boolean save(orm.Especialidad especialidad) throws PersistentException {
		try {
			orm.Taller2PersistentManager.instance().saveObject(especialidad);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(orm.Especialidad especialidad) throws PersistentException {
		try {
			orm.Taller2PersistentManager.instance().deleteObject(especialidad);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean refresh(orm.Especialidad especialidad) throws PersistentException {
		try {
			orm.Taller2PersistentManager.instance().getSession().refresh(especialidad);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(orm.Especialidad especialidad) throws PersistentException {
		try {
			orm.Taller2PersistentManager.instance().getSession().evict(especialidad);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
