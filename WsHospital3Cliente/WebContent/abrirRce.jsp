			...
			<form method="post" action="HCE">
				...
				<div class="row">
					<div class="col-lg-6">
						...
						<select disabled class="form-control" id="selecdiag" name="diagnostico">
							<%
								String idDiagnostico="";
							String iddDiagnostico="";
							String nombreDiagnos="";
								try{
									idDiagnostico=request.getAttribute("idDiagnostico").toString();
								String diagnosti=s.obtenerDiagnosticoporId(idDiagnostico);	
								DiagnosticoVO diagnos=Transformar.jsonToDiagnosticoNoLista(diagnosti);
								iddDiagnostico=	diagnos.getId()+"";
								nombreDiagnos=diagnos.getNombre();		
								}catch(NullPointerException e){
									
								}
							%>
							<option hidden value="<%=iddDiagnostico%>"><%=nombreDiagnos%></option>
				...
				<div class="row">
					...
					<div class="col-lg-6">
						...
						<div class="col-lg-11" style="overflow: scroll; height: 200px;">
							...
							%>
							<div class="col-lg-8">
								<label class="radio-inline"><input type="radio" disabled <%if(certificado10.equals("|9")){ %> checked<%} %>
				...
				<div class="row">
					<div class="col-lg-6">
						...
						<div class="clearfix visible-lg"></div>
						<div class="col-lg-12">
							<select disabled class="form-control" id="actividades" name="actividad">
								<%
									String idActividad="";
								String actividad="";
								String idDiag="";
								String nombreActi="";
								try{
									idActividad=request.getAttribute("idActividad").toString();
									actividad=s.obtenerActividadporId(idActividad);
									ActividadVO acti=Transformar.jsonToActividadNoLista(actividad);
									nombreActi=acti.getNombreActividad();
									idDiag=acti.getDiagnostico().getId()+"";
								}catch(NullPointerException e){
									
								}
								%>
								<option hidden value="<%=idDiag%>.<%=idActividad%>"><%=nombreActi %></option>
					...
					<div class="col-lg-6">
						...
						<div class="clearfix visible-lg"></div>
						<div class="col-lg-12">
							<select disabled class="form-control" id="procedimientos"
								name=procedimiento>
								<%
								...
								try{
									idProcedimiento=request.getAttribute("idProcedimiento").toString();
								...
								%>
								<option hidden value="0"><%=nombreProcedi %></option>
