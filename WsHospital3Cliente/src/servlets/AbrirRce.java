...
public class AbrirRce extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try{
			...
			RceVO rceVo=Transformar.jsonToRce3(rce);
			...
			request.setAttribute("uuid", rceVo.getUuid());
			request.setAttribute("idHce", rceVo.getIdHce().getId());
			request.setAttribute("idHoraMedica", rceVo.getIdHoraMedica());
			...
			request.setAttribute("receta", rceVo.getReceta());
			request.setAttribute("idDiagnostico", rceVo.getIdDiagnostico().getId());
			request.setAttribute("idActividad", rceVo.getIdActividad().getId());
			...
			String fechaAntencion=Transformar.datetoStringRce(rceVo.getFechaAtencion());
			request.setAttribute("fechaAtencion",fechaAntencion );
			request.setAttribute("horaInicioAtencion", rceVo.getHoraInicioAtencion());
			String fechaCierre=Transformar.datetoStringRce(rceVo.getFechaCierreClinico());
